package com.example.sust.clima.controllers;
...
import com.example.sust.clima.models.UserRepository;

import jakarta.servlet.http.HttpSession;

import com.example.sust.clima.daos.UsersDao;
import com.example.sust.clima.models.User;
...
public class UserController {
  ...
  public String login(@RequestParam String username, @RequestParam String password, RedirectAttributes redAt,
    ...
    // me traigo la password encriptada proveniente de la base de datos
